...
Object subclass: #Cancha
	instanceVariableNames: 'id descripcion tipo precioBaseHora listaDeTurnos'
	classVariableNames: ''
	poolDictionaries: ''
	classInstanceVariableNames: ''!
...
Object subclass: #Pago
	instanceVariableNames: 'id fechaHora monto estado'
	classVariableNames: ''
	poolDictionaries: ''
	classInstanceVariableNames: ''!
...
Object subclass: #SistemaAlquiler
	instanceVariableNames: 'nombre clientes canchas reservas pagos'
	classVariableNames: ''
	poolDictionaries: ''
	classInstanceVariableNames: ''!
...
Cancha guid: (GUID fromString: '{e50baa3f-c9b4-45e4-9f97-c6b59e38a7d2}')!
...
listaDeTurnos: unaLista
listaDeTurnos:= unaLista!

precioBaseHora
^precioBaseHora!

precioBaseHora: unPrecio
precioBaseHora:= unPrecio!
...
id:!public! !
initialize!public! !
listaDeTurnos!public! !
listaDeTurnos:!public! !
precioBaseHora!public! !
precioBaseHora:!public! !
tipo!public! !
tipo:!public! !
!
...
id: unId descripcion: unaDescripcion tipo: unTipo precioBaseHora: unPrecio listaDeTurnos: unaLista

^self new id: unId;  descripcion: unaDescripcion; tipo: unTipo; precioBaseHora: unPrecio; listaDeTurnos: unaLista; yourself .! !

!Cancha class categoriesForMethods!
id:descripcion:tipo:precioBaseHora:listaDeTurnos:!public! !
!

Cliente guid: (GUID fromString: '{9524c5ac-7cb7-4af0-a286-3c98aa6af653}')!
...
modiDescripcion: unaDescripcion
descripcion := unaDescripcion!
...
modiDescripcion:!public! !
modiId:!public! !
verDescripcion!public! !
verId!public! !
!

!MetodoPago class methodsFor!

id: unId descripcion: unaDescripcion

^self new modiId: unId; modiDescripcion: unaDescripcion! !

!MetodoPago class categoriesForMethods!
id:descripcion:!public! !
!

Pago guid: (GUID fromString: '{230b2b5c-ab72-4869-9330-25585f921a09}')!
...
id: unId fechaHora: unaFechaHora monto: unMonto
^self new modiId: unId; modiFechaHora: unaFechaHora; modiMonto: unMonto!

id: unId fechaHora: unaFechaHora monto: unMonto estado: unEstado
^self new modiId: unId; modiFechaHora: unaFechaHora; modiMonto: unMonto; modiEstado: unEstado! !

!Pago class categoriesForMethods!
id:fechaHora:monto:!public! !
id:fechaHora:monto:estado:!public! !
!

Reserva guid: (GUID fromString: '{5262611a-6404-471f-a5cc-4bade74bbd77}')!
...
calcularCosto: precioPorHora cantidadHoras: cantidadHoras
| total |
total := precioPorHora * cantidadHoras.
self modiImporteTotal: total.
^total!
...
modiFechaAlta: unaFechaDeAlta
fechaAlta := unaFechaDeAlta!

modiId: unId
id:= unId!

modiImporteTotal: unImporteTotal
importeTotal := unImporteTotal!

modiReservaEstado: unEstado
reservaEstado := unEstado!
...
calcularCosto:cantidadHoras:!public! !
modiCanchaId:!public! !
modiClienteId:!public! !
modiFechaAlta:!public! !
modiId:!public! !
modiImporteTotal:!public! !
modiReservaEstado:!public! !
verCanchaId!public! !
verClienteId!public! !
verFechaAlta!public! !
verId!public! !
verImporteTotal!public! !
...
!SistemaAlquiler categoriesForClass!Kernel-Objects! !
...
modiFechaHoraFin: unaFechaHoraFin
fechaHoraFin := unaFechaHoraFin!

modiFechaHoraInicio: unaFechaHoraInicio
...
modiEstado:!public! !
modiFechaHoraFin:!public! !
modiFechaHoraInicio:!public! !
modiId:!public! !
verEstado!public! !
verFechaHoraFin!public! !
verFechaHoraInicio!public! !
verId!public! !
!
...
^self new modiId: unId; modiFechaHoraInicio: unaFechaHoraInicio; modiFechaHoraFin: unaFechaHoraFin; modiEstado: unEstado! !
